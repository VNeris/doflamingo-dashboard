        ...
        <section className="container mx-auto justify-center items-center p-4">
            <div className="flex">
                <div className="box flex flex-col px-3">
                    ...
                    <button type="button" className="text-black border items-center justify-center font-semibold flex rounded-full border-zinc-300 m-10 p-2"><img src={"/assets/google.png"} className="w-5 me-2" alt="google-icon" />Sign in With Google</button>
                ...
                <div className="hidden lg:flex ">
                    <img src={"/assets/teste.png"} className="w-[975px]" alt="" />
                </div>
